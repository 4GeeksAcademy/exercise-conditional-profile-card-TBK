    ...
    variables.country == null ? "Country" : variables.country
          ...
          <ul class="position- ${variables.socialMediaPosition}">
            ...
            <li><a href="https://twitter.com/${
              variables.twitter == null ? "4geeksacademycl" : variables.twitter
...
window.onload = function() {
  window.variables = {
    ...
    background:
      "https://img.freepik.com/premium-vector/rain-banana_62000-6.jpg",
    // this is the url for the profile avatar
    avatarURL:
      "https://i.pinimg.com/736x/88/f0/3d/88f03de22c4077d6a2738421d2e93a19.jpg",
